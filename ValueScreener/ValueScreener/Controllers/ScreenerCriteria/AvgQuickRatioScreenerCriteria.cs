...
{
    class AvgQuickRatioScreenerCriteria : AbstractCriteria
    {
        public override string Id => ColumnConstants.AvgQuickRatio;
        public override string DisplayName => ColumnConstants.AvgQuickRatioDisplay;
        ...
        {
            return stock.PricingResult.AverageQuickRatio;
        }
