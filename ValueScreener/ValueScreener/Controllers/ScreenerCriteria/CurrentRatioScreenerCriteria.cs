...
{
    class CurrentRatioScreenerCriteria : AbstractCriteria
    {
        public override string Id => ColumnConstants.CurrentRatio;
        public override string DisplayName => ColumnConstants.CurrentRatioDisplay;
        ...
        {
            return stock.PricingResult.CurrentCurrentRatio;
        }
