...
{
    class SolvencyScreenerCriteria : AbstractCriteria
    {
        public override string Id => ColumnConstants.SolvencyRatio;
        public override string DisplayName => ColumnConstants.SolvencyRatioDisplay;
        ...
        {
            return stock.PricingResult.LeverageRatio;
        }
