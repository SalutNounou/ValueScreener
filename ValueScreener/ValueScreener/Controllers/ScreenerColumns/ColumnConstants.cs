...
namespace ValueScreener.Controllers.ScreenerColumns
{
    public class ColumnConstants
    {
        ...
        public const string PriceToSalesDisplay = "P/S Ratio";
        ...
        public const string PbRatio = "pbratio";
        public const string PbRatioDisplay = "P/B Ratio";
